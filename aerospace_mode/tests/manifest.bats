...
@test "manifest declares every wire op the script emits" {
  for op in add set remove query move; do
...
@test "plugin.yaml is valid YAML with owns=aerospace_mode." {
